...
-- mapp
vim.keymap.set("n", "<leader>cgr", function() vim.cmd("term cargo run") end, { desc = "Run `cargo run`" })
vim.keymap.set("n", "<leader>cgt", function() vim.cmd("term cargo test --lib") end, { desc = "Run `cargo test --lib`" })
